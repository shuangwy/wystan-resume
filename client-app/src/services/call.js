...
const callApi =
  ({ uri, method, params = {}, onSuccess, onFailure, ...rest }) =>
      async ({
          dispatch,
          state,
          actions: {
              MessageModel: { addErrorMessage, addLoadingMessage, addSuccessMessage },
          },
      }) => {
